...
function onHamburgerClick() {
  document?.getElementById('nav-phone')?.classList?.toggle('nav-closed')
  document?.getElementById('nav-phone')?.classList?.toggle('nav-opened')
}
</script>

<template>
  <header class="main-page-header" id="main-page-header">
